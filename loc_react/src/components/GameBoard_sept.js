...
let findWinningPatterns = (arr) => {
  ...
  // console.log(`This in winpat: ${winPat}`)
    return cellSpr.map((cellSpace) => {
      console.log(`This in cellSpace: ${cellSpace.id}`)
      ...
      // console.log(`This is firstPlayer: ${firstPlayer}`);
      // console.log(`This is firstPlayer: ${firstPlayer} ${cellSpace.value}`);
      console.log(`This is cellSpace.id: ${cellSpace.id}`);
     
      // let foundWinPat = true;
      // if(cellValue ===patternOne && cellValue === patternTwo && cellValue === patternThree) {
